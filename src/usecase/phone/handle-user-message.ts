...
import { autoApproveJoinRequestsStep } from './steps/auto-approve-join-requests-step.ts'
...
const userMessagePipeline = pipeline<PhoneFlowContext>(`user_message`, [
	...
	branch(
		...
		[
			savePhoneStep,
			notifyAdminsPhoneStep,
			autoApproveJoinRequestsStep,
			notifyUserContactReceived,
		],
